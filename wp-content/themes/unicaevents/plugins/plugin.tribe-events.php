...
if (!function_exists('unicaevents_tribe_events_theme_setup')) {
	...
	function unicaevents_tribe_events_theme_setup() {
		if (unicaevents_exists_tribe_events()) {
			...
			add_filter('tribe_events_google_maps_api',     'unicaevents_tribe_events_google_maps_api');	
...
if ( !function_exists( 'unicaevents_tribe_events_google_maps_api' ) ) {
   //add_filter('tribe_events_google_maps_api', 'unicaevents_tribe_events_google_maps_api');
	function unicaevents_tribe_events_google_maps_api($url) {
		$api_key = unicaevents_get_theme_option('api_google');
		if ($api_key) {
			$url = unicaevents_add_to_url($url, array(
				'key' => $api_key
				));
		}
		return $url;
