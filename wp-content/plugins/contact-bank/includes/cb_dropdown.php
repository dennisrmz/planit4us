					...
					<div class="widget-layout">
						...
						<div class="widget-layout-body">
							...
							<div class="layout-control-group">
								...
								<div class="layout-controls">
									<input type="text" class="layout-span12" id="ux_tooltip_control_<?php echo $dynamicId; ?>" placeholder="<?php _e( "This Feature is only available in Premium Editions!", contact_bank ); ?>" name="ux_tooltip_control_<?php echo $dynamicId; ?>" readonly="readonly"/>
								</div>
							</div>
							<div class="layout-control-group">
